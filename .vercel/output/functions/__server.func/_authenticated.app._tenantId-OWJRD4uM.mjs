...
import { d as Route, u as useServerFn, L as LanguageSwitcher, c as useCurrency, S as SUPPORTED_CURRENCIES } from "./_ssr/router-Bkldq2G_.mjs";
import { u as useQueryClient, a as useQuery, b as useMutation } from "./_libs/tanstack__react-query.mjs";
import { l as listItems, c as createItem, u as updateItem, d as deleteItem, r as reorderItems, a as listAllEntries, f as formatDateTime, b as listEntriesForItem, e as upsertEntry } from "./_ssr/format-date-Crm4zV1h.mjs";
import { c as createSsrRpc } from "./_ssr/createSsrRpc-B_sfLEGR.mjs";
import { c as createServerFn } from "./_ssr/server-CERHnNmm.mjs";
import { r as requireSupabaseAuth } from "./_ssr/auth-middleware-3tVLAvsj.mjs";
import { e as ensureSupabase } from "./_ssr/client-cGEFPIfD.mjs";
...
import { i as isSuperuser, A as AlertDialog, f as AlertDialogContent, h as AlertDialogHeader, j as AlertDialogTitle, o as AlertDialogDescription, k as AlertDialogFooter, m as AlertDialogCancel, n as AlertDialogAction, p as cn } from "./_ssr/superusers.functions-IPqWnlei.mjs";
import { l as listMyTenants, a as listTenantMembers, f as setLastTenantId } from "./_ssr/tenants.functions-D_PYp7Jq.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen flex-col bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between border-b border-border px-4 py-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-xs text-muted-foreground", children: [
        ...
        isAdmin ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: copyJoinCode, title: t("workspace.joinCodeTitle"), className: "rounded bg-accent px-2 py-1 hover:bg-accent/80", children: [
...
function TaskLists({
  ...
  const reorderM = useMutation({
    ...
    onMutate: (orderedIds) => {
      ...
      if (prev) {
        ...
        const others = prev.filter((t2) => !reorderedSet.has(t2.id));
        const reordered = orderedIds.map((id) => prev.find((t2) => t2.id === id)).filter(Boolean);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TaskGroup, { name: t("workspace.tasks"), tasks, userId: void 0, onAdd: (title) => createM.mutate({
    title
